...
const KycPage = () => {
  ...
  const handleKyc = async () => {
    ...
    formData.append("documentId", documentType);
    ...
    try {
      ...
      if (status === "success") {
        ...
        if (confidence === "low" || blur === "yes" || partialId === "yes") {
          ...
          setTimeout(() => navigate("/admin-driver-liveiness"), 2000); // Redirect after 2 seconds
        }
      } else {
        setFeedback({
          success: false,
  ...
  return (
    <KycContainer>
      ...
      <Guidelines>
        ...
        <GuidelineList>
          <li>Upload a clear image or PDF of your selected document type.</li>
